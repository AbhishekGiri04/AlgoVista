...
int main() {
    cout << "=== Graph Data Structure ===" << endl;
    Graph g(5);
...
if __name__ == "__main__":
    main()`,
    java: `/**
 * Graph Data Structure - Java Implementation
 * Network of connected nodes using adjacency list
 */
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  {selectedLanguage === 'cpp' ? 'graph.cpp' : 
                   selectedLanguage === 'c' ? 'graph.c' :
                   selectedLanguage === 'python' ? 'graph.py' : 'Graph.java'}
                </span>
              </div>
              <button
                onClick={() => {
