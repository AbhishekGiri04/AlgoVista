        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '30px' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <span style={{ color: '#94a3b8' }}>Stack Size: </span>
                <span style={{ fontWeight: '700', color: '#60a5fa' }}>{stack.length}/{maxSize}</span>
              </div>
              <div>
                <span style={{ color: '#94a3b8' }}>Top Element: </span>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                {[
                  ...
                  { label: 'Traverse', action: traverseStack, color: '#8b5cf6', disabled: stack.length === 0 },
                  { label: 'Clear', action: clearStack, color: '#64748b', disabled: stack.length === 0 }
