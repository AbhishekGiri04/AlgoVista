  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden" style={{
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 flex flex-col items-center justify-center min-h-screen">
        <motion.a 
          href="/" 
          className="absolute top-8 left-8 bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-6 py-3 rounded-xl font-semibold shadow-lg backdrop-blur-md border border-cyan-400/30"
