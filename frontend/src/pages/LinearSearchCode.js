...
const LinearSearchCode = () => {
  ...
  const codeExamples = {
    cpp: `/**
 * Linear Search Algorithm - C++ Implementation
...
int main() {
    ...
    LinearSearch::printArray(arr, "Array");
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  {selectedLanguage === 'cpp' ? 'linear_search.cpp' : 
                   selectedLanguage === 'c' ? 'linear_search.c' :
                   selectedLanguage === 'python' ? 'linear_search.py' : 'LinearSearch.java'}
                </span>
              </div>
              <button
                onClick={() => {
